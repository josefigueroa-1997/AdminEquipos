...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <form method="post" runat="server">
        ...
        <label class="text-xl font-bold">Comuna</label>
         <asp:TextBox ID="TextBox2" Visible="false" runat="server" CssClass="border p-2 mt-2" />
         <asp:Label ID="Label2" runat="server" Visible="false" Text="Nueva Comuna"></asp:Label>
         <asp:DropDownList ID="ddlComunas" runat="server" CssClass="border p-2 mt-2" Height="43px" AutoPostBack="true"></asp:DropDownList>
        <br />
