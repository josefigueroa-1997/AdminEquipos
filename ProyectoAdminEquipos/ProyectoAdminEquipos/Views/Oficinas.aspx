<%@ Page Language="vb" Async="true" AutoEventWireup="false" CodeBehind="Oficinas.aspx.vb" MasterPageFile="~/Site.Master" Inherits="ProyectoAdminEquipos.Oficinas" %>
     ...
     <form method="post" runat="server">
        <div class="overflow-x-auto">
            ...
            <Columns>
             ...
             <asp:BoundField DataField="ID_COMUNA" HeaderText="Id Comuna" SortExpression="Nombre" ItemStyle-CssClass="px-6 py-4 whitespace-nowrap text-sm text-gray-500" />  
             <asp:BoundField DataField="NombreComuna" HeaderText="Nombre Comuna" SortExpression="Nombre" ItemStyle-CssClass="px-6 py-4 whitespace-nowrap text-sm text-gray-500" />
             <asp:BoundField DataField="ID_REGION" HeaderText="Id Región" SortExpression="Nombre" ItemStyle-CssClass="px-6 py-4 whitespace-nowrap text-sm text-gray-500" />   
        ...
        <asp:TextBox ID="TextBox1" runat="server" CssClass="border p-2 mt-2" />
         ...
         <asp:DropDownList ID="ddlRegiones" runat="server" AutoPostBack="true" CssClass="border p-2 mt-2" Height="43px"></asp:DropDownList>
        <label class="text-xl font-bold">Comuna</label>
         <asp:DropDownList ID="ddlComunas" runat="server" CssClass="border p-2 mt-2" Height="43px"></asp:DropDownList>
        <br />
